  ...
  return (
    <Fragment>
      <html lang="en" className={theme === 'dark' ? 'dark' : ''}>
        ...
        <body className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white min-h-screen transition-colors duration-200">
          <div id="app" className="min-h-screen flex flex-col">
            ...
            {/* Main Content Area - Similar to Next.js children in layout */}
