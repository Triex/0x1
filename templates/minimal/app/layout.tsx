...
export default function RootLayout({ children }: { children: JSX.Element }) {
  return (
    <html lang="en" className="h-full">
      ...
      <body className="h-full flex flex-col bg-gradient-to-br from-gray-200 via-violet-200/70 to-indigo-200/60 dark:from-gray-950 dark:via-violet-950/40 dark:to-purple-900/20">
