...
// JSX Runtime exports
export { Fragment, createElement, jsx, jsxDEV, jsxs, type JSXElement } from './jsx-runtime.js';
...
export { Head, getGlobalMetadata, initializeHeadManagement, setGlobalMetadata, updateDocumentHead, useMetadata } from './core/head.js';
